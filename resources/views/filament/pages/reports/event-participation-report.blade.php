<x-filament-panels::page>
    <div class="flex flex-col gap-6">
        <div class="flex items-center justify-between">
            ...
            <p class="text-gray-600">Event attendance and registration statistics</p>
        </div>
            ...
            <div class="bg-white rounded-lg shadow p-6 border border-gray-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-700">{{ \App\Models\Event::count() }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6 border border-gray-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-700">{{ \App\Models\EventRegistration::count() }}</p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow p-6 border border-gray-200">
            <h3 class="text-lg font-semibold text-gray-700 mb-4">Event Participation Details</h3>
